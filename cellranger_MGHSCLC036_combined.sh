#!/bin/bash
#SBATCH --job-name=MGHSCLC036_combined
#SBATCH --partition=bigmem
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=120G
#SBATCH --output=/data/rama/labMembers/mao20/MGH2024/CTC/sh/log/MGHSCLC036_combined.out
#SBATCH --error=/data/rama/labMembers/mao20/MGH2024/CTC/sh/log/MGHSCLC036_combined.err
#SBATCH --time=48:00:00

cd /data/rama/labMembers/mao20/MGH2024/CTC/sh/results 


cellranger count --id=MGHSCLC036_combined \
	...
	--sample=MGHSCLC036_10x,MGHSCLC036_10x_2 \
